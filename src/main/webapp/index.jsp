	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="img/hospital.jpg" class="d-block w-100" alt="img"
					height="500px">
			</div>
			<div class="carousel-item">
				<img src="img/doctors.jpg" class="d-block w-100" alt="img"
					height="500px">
			</div>
			<div class="carousel-item">
				<img src="img/medical.jpg" class="d-block w-100" alt="img"
					height="500px">
			</div>
		</div>
