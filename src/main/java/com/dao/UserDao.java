...
public class UserDao {
	 ...
	 * false;
	 * 
	 * try { String sql = "select * from user where id=? and password=?";
	 ...
	 * false;
	 * 
	 * try { String sql = "update user set password=? where id=?"; PreparedStatement
	 * ps = conn.prepareStatement(sql); ps.setString(1, newPassword); ps.setInt(2,
	 * userid);
	 * 
