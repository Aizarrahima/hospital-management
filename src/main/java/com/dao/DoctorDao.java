...
public class DoctorDao {
	 ...
	 * }
	 * 
	 * } catch (Exception e) { e.printStackTrace(); } return d; }
	 * 
	 ...
	 * return f; }
	 * 
	 * public boolean deleteDoctor(int id) { boolean f = false; try { String sql =
	 * "delete from doctor where id=?"; PreparedStatement ps =
	 ...
	 * ps.setString(2, psw);
	 * 
	 * ResultSet rs = ps.executeQuery(); while (rs.next()) { d = new Doctor(); d =
